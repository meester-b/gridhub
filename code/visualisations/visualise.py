...
def visualise(grid):
    ...
    for i in range(len(house.cables[0].path)-1): 
        x_begin = house.cables[0].path[i][0]
        y_begin = house.cables[0].path[i][1]
        x_end = house.cables[0].path[i+1][0]
        y_end = house.cables[0].path[i+1][1]
